...
class TeamshalfSearchForm(FlaskForm):
    ...
    lgID = StringField('League ID', [Length(max=2)], default="", render_kw={'placeholder': 'Enter the team\'s league ID'})
    divID = StringField('Division ID', [Length(max=1)], default="", render_kw={'placeholder': 'Enter the team\'s division ID'})
    Half = StringField('Half', [Length(max=1)], default="", render_kw={'placeholder': 'Enter the half season'})
    DivWin = StringField('Division Win', [Length(max=1)], default="", render_kw={'placeholder': 'Has the team won the division? (Y for yes, N for no)'})
...
class TeamshalfUpdateForm(FlaskForm):
    yearID = IntegerField('Year', default=-1, render_kw={'placeholder': 'Enter the year'})
    teamID = StringField('Team ID', [Length(max=3)], default="", render_kw={'placeholder': 'Enter the team\'s ID'})
    Half = StringField('Half', [Length(max=1)], default="", render_kw={'placeholder': 'Enter the half season'})
    DivWin = StringField('Division Win', [Length(max=1)], default="", render_kw={'placeholder': 'Has the team won the division? (Y for yes, N for no)'})
...
class TeamshalfInsertionForm(FlaskForm):
    name = StringField('Team Name', [Length(max=100)], default="", render_kw={'placeholder': 'Enter the team\'s name'})
    yearID = IntegerField('Year', default=-1, render_kw={'placeholder': 'Enter the year'})
    teamID = StringField('Team ID', [Length(max=3)], default="", render_kw={'placeholder': 'Enter the team\'s ID'})
    lgID = StringField('League ID', [Length(max=2)], default="", render_kw={'placeholder': 'Enter the team\'s league ID'})
